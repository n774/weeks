...
class WeeksControllerTest < ActionController::TestCase
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post :create, week: { comment: @week.comment, employee_id: @week.employee_id, report: @week.report, reported_on: @week.reported_on }
    end
  ...
  test "should update week" do
    patch :update, id: @week, week: { comment: @week.comment, employee_id: @week.employee_id, report: @week.report, reported_on: @week.reported_on }
    assert_redirected_to week_path(assigns(:week))
  end
